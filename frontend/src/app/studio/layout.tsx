...
function StudioContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex bg-background text-foreground h-[calc(100vh/0.67)] w-full overflow-hidden font-sans selection:bg-primary selection:text-white transition-colors duration-500">
